...
const recentTools = [
  ...
  { label: "AI Logo", icon: FileType, href: "/tools" },
  { label: "AI 文案", icon: Type, href: "/tools" },
  { label: "AI 消除", icon: Eraser, href: "/eraser" },
  { label: "穿戴套图", icon: Shirt, href: "/tools" },
];

/* ── AI 商拍 ────────────────────────────────── */
const aiShootTools = [
  { title: "AI 商品套图", desc: "主图场景全套一键生成", href: "/product-photo", icon: ShoppingBag, gradient: "from-blue-100 to-cyan-50" },
  { title: "A+ 详情页", desc: "高转化详情页一键生成", href: "/tools", icon: FileText, gradient: "from-amber-100 to-yellow-50" },
  { title: "批量套图", desc: "夜间托管生图，效率提升", href: "/tools", icon: Layers, gradient: "from-emerald-100 to-green-50" },
  { title: "爆款图复刻", desc: "一键复刻电商爆款图片", href: "/tools", icon: Copy, gradient: "from-red-100 to-orange-50" },
  { title: "AI 带货视频", desc: "爆款带货视频一键生成", href: "/video", icon: Video, gradient: "from-purple-100 to-violet-50" },
  { title: "AI 穿戴套图", desc: "成套服装一键上身", href: "/tools", icon: Shirt, gradient: "from-pink-100 to-rose-50" },
];
...
const imageTools = [
  ...
  { title: "证件照", desc: "换底色/改尺寸/排版", href: "/tools", icon: CreditCard, gradient: "from-blue-100 to-sky-50" },
  { title: "无损改尺寸", desc: "缩放图片，清晰不失真", href: "/tools", icon: Expand, gradient: "from-indigo-100 to-blue-50" },
  { title: "拼图", desc: "1秒拼出高级感", href: "/tools", icon: Combine, gradient: "from-violet-100 to-purple-50" },
  { title: "AI 扩图", desc: "轻松延展画面", href: "/expand", icon: Expand, gradient: "from-cyan-100 to-teal-50" },
  { title: "形象照", desc: "一键换脸变装", href: "/tools", icon: UserCircle, gradient: "from-rose-100 to-pink-50" },
  { title: "图片批处理", desc: "一站式批量修图", href: "/tools", icon: GridIcon, gradient: "from-neutral-100 to-neutral-50" },
];

/* ── AI 设计 ────────────────────────────────── */
const designTools = [
  { title: "AI Logo", desc: "在线智能Logo生成", href: "/tools", icon: FileType, gradient: "from-green-100 to-emerald-50" },
  { title: "AI 图文笔记", desc: "爆款图文批量一键排版", href: "/tools", icon: ImageIcon, gradient: "from-amber-100 to-orange-50" },
  { title: "LivePPT", desc: "一句话生成高质量PPT", href: "/tools", icon: Presentation, gradient: "from-blue-100 to-indigo-50" },
  { title: "AI 文案", desc: "10秒生成爆款文案", href: "/tools", icon: Type, gradient: "from-purple-100 to-violet-50" },
