...
export default function EditorPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center justify-between px-6 py-3 border-b border-neutral-200/60 dark:border-neutral-800/60 bg-white dark:bg-neutral-900">
      ...
      {previewUrl ? (
        <div className="flex-1 flex">
          {/* Left toolbar */}
          <div className="w-16 border-r border-neutral-200/60 dark:border-neutral-800/60 bg-white dark:bg-neutral-900 flex flex-col items-center py-3 gap-1">
            {LEFT_TOOLS.map((tool) => {
          ...
          {/* Right panel */}
          <div className="w-[240px] border-l border-neutral-200/60 dark:border-neutral-800/60 bg-white dark:bg-neutral-900 p-4">
